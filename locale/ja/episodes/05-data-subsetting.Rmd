...
are called _atomic_ vectors because they can't be further simplified.
...
every element _except_ for the one specified:
...
Similarly, `[[` will act to extract _a single column_:
